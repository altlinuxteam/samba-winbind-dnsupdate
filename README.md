...
* Установка unit-файлов systemd
      ...
      # install -Dm 644 winbind-dnsupdate.timer /etc/systemd/system/winbind-dnsupdate.timer
      # install -Dm 644 winbind-dnsupdate.service /etc/systemd/system/winbind-dnsupdate.service
